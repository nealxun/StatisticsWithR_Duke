...
```{r sim-unfair-coin}
sim_unfair_coin <- sample(coin_outcomes, size = 1000, replace = TRUE, 
                          prob = c(0.2, 0.8))
...
answer: the disbributions look very similar. Therefore, there doesn't apper to be evidence or Kobe Bryant's hot hand.
