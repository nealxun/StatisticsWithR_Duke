...
##### answer: Each additional home run increases runs by 1.83.
...
yhat <- predict(m2, new = data.frame(at_bats = 5579))
residuals <- 713 - yhat
...
##### answer: The residuals show a curved pattern.
...
m3 <- lm(runs ~ new_onbase, data = mlb11)
summary(m3)
