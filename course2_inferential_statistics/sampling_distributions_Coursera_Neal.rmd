...
```
There are 15,000 elements in sample_mean50, with each represents a sample mean of size 50.
The sampling distribution nearly follows normal distribution, the center is `r round(mean(sample_means50$x_bar), 2)`
...
paste0("mean of sampling distribution = ", round(mean(sample_means50$x_bar), 2))
paste0("SE of sampling distribution = ", round(sd(sample_means50$x_bar), 2))
```
...
paste0("mean of sampling distribution = ", round(mean(sample_means150$x_bar), 2))
paste0("SE of sampling distribution = ", round(sd(sample_means150$x_bar), 2))
