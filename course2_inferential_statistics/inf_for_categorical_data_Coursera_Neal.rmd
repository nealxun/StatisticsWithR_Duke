...
df <- us12 %>%
        group_by(response) %>%
        summarise(count = n()) %>%
        mutate(percentage = count/nrow(us12))
df
...
**a measure of how confidence your point estimate is.**
...
**answer: The most conservative estimate when calculating a confidence interval occurs when $p$ is set to 1.**
